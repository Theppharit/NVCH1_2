...
<head>
    ...
    <title>rattanachot thuengin</title>
...
<body>
    ...
    <!-- ส่วนหัว -->
    <div class="div-title">
        <h1 class="title-h1">rattanachot thuengin</h1>
    </div>

    <!-- กล่องที่ 1 -->
    <div class="box box-blue">
        <h2 class="title-h2">Halo babyyy</h2>
    ...
    <div class="box box-yellow">
        <h2 class="title-h3">hello wayyyyyy</h2>
    ...
    <div class="box box-purple">
        <h4 class="title-h5">Hello to gooooooo</h4>
    </div>
