...
<body>
    ...
    <section class="section-content">
        ...
        <iframe width="560" height="315" src="https://youtu.be/Gy-MZjiFv2M?si=zntbIklqpXOuw6J0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>

        <iframe src="https://maps.app.goo.gl/a4cuu8X9h2TuQL8A7" width="560" height="315" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
